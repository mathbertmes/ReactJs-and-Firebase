    ...
    firebase
      ...
      .then((h) => {
        ...
        firebase
          ...
          .get()
          .then((u) => {
            let idsHoteis = u.data().idsHoteis;
            idsHoteis.push(h.id);
            let us = u.data();
            delete us.idsHoteis;
            us.idsHoteis = idsHoteis;
            firebase
              .firestore()
              .collection("Usuarios")
              .doc(this.props.user.id)
    ...
    firebase
      ...
      .then((h) => {
        firebase
          ...
          .collection("configHoteis")
          .doc("hCwGAgOZcSV8qQCTDdbR")
          .update({ qtdDocumentos: h.data().qtdDocumentos + 1 });
      })
      .then(() => {
        this.setState({
          status: false,
        ...
        <div id="cadastroGeral">
          ...
          <div className="camposJuntos">
            ...
            <div>
              ...
              <select
                name="pais"
                value={this.state.localizacao.pais}
                onChange={this.handleChangelocal}
                className="selects"
              >
                {paises.map((hotel) => (
            ...
            <div>
              ...
              <input
                name="bairro"
                value={this.state.localizacao.bairro}
                onChange={this.handleChangelocal}
                className="inputsTextSS"
              ></input>
            </div>
            ...
            <div>
              ...
              <input
                name="rua"
                value={this.state.localizacao.rua}
                onChange={this.handleChangelocal}
                className="inputsTextSS"
              ></input>
            </div>
          ...
          <div className="camposJuntos">
            <div>
              <input
                value={this.state.comodidades.piscina}
                checked={this.state.comodidades.piscina}
            ...
            <div>
              <input
                value={this.state.comodidades.spa}
                checked={this.state.comodidades.spa}
                onChange={this.handleChangeComodidades}
                name="spa"
                type="checkbox"
                class="checkbox"
            ...
            <div>
              <input
                value={this.state.comodidades.wifi}
                checked={this.state.comodidades.wifi}
                onChange={this.handleChangeComodidades}
                name="wifi"
                type="checkbox"
                class="checkbox"
            ...
            <div>
              <input
                value={this.state.comodidades.academia}
                checked={this.state.comodidades.academia}
                onChange={this.handleChangeComodidades}
                name="academia"
                type="checkbox"
                class="checkbox"
            ...
            <div>
              <input
                value={this.state.comodidades.bar}
                checked={this.state.comodidades.bar}
                onChange={this.handleChangeComodidades}
                name="bar"
                type="checkbox"
                class="checkbox"
            ...
            <div>
              <input
                value={this.state.comodidades.playground}
                checked={this.state.comodidades.playground}
                onChange={this.handleChangeComodidades}
                name="playground"
                type="checkbox"
                class="checkbox"
            ...
            <div>
              <input
                value={this.state.comodidades.cafeDaManha}
            ...
            <div>
              <input
                value={this.state.comodidades.servicoDeQuarto}
                checked={this.state.comodidades.servicoDeQuarto}
                onChange={this.handleChangeComodidades}
          ...
          <div className="camposJuntos">
            <div>
              <button id="botaoCadastrar" onClick={this.handleClick}>
                Cadastrar
              </button>
            </div>
          </div>
